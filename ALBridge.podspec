...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/453jerry/ALBridge-iOS"
  ...
  spec.author             = { "Jerry Huang" => "" }
  # Or just: spec.author    = "Jerry Huang"
  # spec.authors            = { "Jerry Huang" => "" }
  # spec.social_media_url   = "https://twitter.com/Jerry Huang"
  ...
  spec.source       = { :git => "https://github.com/453jerry/ALBridge-iOS.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "ALBridge/ALBridge/*.swift"
